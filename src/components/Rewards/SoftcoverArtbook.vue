...
export default {
  ...
  computed: {
    softcoverArtbook: {
      get() {
        return this.$store.state.rewards.softcoverArtbook
      },
      set(value) {
        this.$store.commit('rewards/setSoftcoverArtbook', value)
      },
    },
  },
  watch: {
    softcoverArtbook: function () {
